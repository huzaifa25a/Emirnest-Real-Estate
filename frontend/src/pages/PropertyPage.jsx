...
const PropertyPage = () => {
  ...
  useEffect(() => {
    async function fetchProperty(){
      try{
        const result = await axios.get(`http://localhost:3000/api/property/${property_ID}`);
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center justify-center text-[18px]'>
        <img src={img} className='h-[80vh] w-[120vh]'/>
        <div className='flex flex-col w-[120vh] gap-5 items-start'>
          <span className='font-semibold text-[24px]'>
            AED <span className='font-bold text-[44px]'>{property.price}</span> {property.term}
          </span>
          <div className="flex flex-row gap-2 items-center">
            <img src={location} className="h-[15px]"/>
            {property.address ? <span>{property.address.street}, {property.address.city}</span> : null}
          </div>
          ...
          <div className='flex gap-5 flex-col'>
            ...
            <div className='grid grid-cols-2 grid-rows-2 gap-x-[160px] gap-y-2'>
          ...
          <div className='flex gap-5 flex-col'>
            ...
            <div className='flex flex-col gap-5 justify-center items-center'>
              <span>Name: Huzaifa Pachisa</span>

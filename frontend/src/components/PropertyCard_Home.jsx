  ...
  return (
    <div className="flex flex-col items-center border-gray-200 border-[1px] min-w-[350px]">
      <div className="h-[200px] w-[350px]" style={style}>
        <div className="p-2">
          <span className="text-white bg-[#096da7] p-2 rounded-md">
            AED{" "}
      ...
      <div className="flex flex-col gap-2 p-4 justify-evenly">
        <div className="text-[16px] font-semibold w-full text-center">
          {property.title}
        </div>
        <div className="flex flex-row gap-3">
          ...
          <span className="pr-2 border-r-2 border-gray-200">
            {new Intl.NumberFormat("en-AE").format(property.area)}{" "}
            {property.areaUnit}
          </span>
        </div>
        ...
        <div className="w-full flex items-center justify-center mt-4">
          <button
            className="rounded-lg bg-[#096da7] shadow-md text-white p-2 w-[120px] hover:bg-[#204d67]  transition-all duration-100"
